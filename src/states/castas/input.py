...
class CastasStateInputMixin:
    ...
    def handle_events(self, events):
        # Se for Turno do Diretor, processamos localmente
            ...
            for event in events:
                ...
                if event.type == pygame.KEYDOWN:
                    ...
                    if event.key == pygame.K_ESCAPE:
                        ...
                        return
                    # Diretor encerra turno com Enter
    ...
    def _handle_click_diretor(self, mouse):
        ...
        # Clique nas cartas da mão do Diretor (parte inferior da tela)

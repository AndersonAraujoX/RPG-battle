...
Permite ao jogador configurar:
  - Heróis Defensores
  - Dificuldade do Diretor Isectum (Fácil / Normal / Difícil)
  - Resolução
"""
from __future__ import annotations
import pygame
from .state_base import GameState
from ..config import ESTADO_JOGO_MENU_PRINCIPAL, LARGURA_TELA, ALTURA_TELA, RESOLUCOES, atualizar_resolucao
from ..personagens import Stark, Elden, Doom, Gruu, Kuro, Darwin, Aquele

# Novo estado de jogo para Castas
...
DIFICULDADES_CASTAS = [
    {"id": "facil",   "nome": "Fácil",
     "desc": "Diretor com 2 ações/turno. Mão de 2 insetos.",
     "acoes_diretor": 2, "tam_mao_diretor": 2, "hp_fortaleza": 30},
    {"id": "normal",  "nome": "Normal",
     "desc": "Diretor com 3 ações/turno. Mão de 3 insetos.",
     "acoes_diretor": 3, "tam_mao_diretor": 3, "hp_fortaleza": 20},
    {"id": "dificil", "nome": "Difícil",
     "desc": "Diretor com 4 ações/turno. Mão de 4 insetos.",
     "acoes_diretor": 4, "tam_mao_diretor": 4, "hp_fortaleza": 15},
]
...
class CastasSetupState(GameState):
        ...
        for event in events:
            ...
            if event.type == pygame.MOUSEBUTTONDOWN and event.button == 1:
                ...
                if self.btn_iniciar.collidepoint(mouse):
                    ...
                    from .castas_state import CastasState
    ...
    def draw(self, tela):
        ...
        # Fundo decorativo — padrão hexagonal subtil
    ...
    def _draw_titulo(self, tela, W):
        ...
        sub = self.fMi.render("Modo de Cartas Assimétrico — Defensores vs. Diretor Isectum", True, C_DIM)
